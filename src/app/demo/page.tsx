...
export default function DemoPortal() {
  ...
  return (
    <div style={{ minHeight: '100vh', background: '#080808', fontFamily: 'var(--font-inter, \'Inter\', system-ui, sans-serif)', color: '#fff' }}>
      ...
      >
        <div className="demo-top-bar-left" style={{ display: 'flex', alignItems: 'center', gap: '20px' }}>
          {/* Back link */}
          <a
            href="/"
            style={{ display: 'inline-flex', alignItems: 'center', gap: '6px', color: '#666', fontSize: '13px', textDecoration: 'none', transition: 'color 0.15s' }}
        ...
        <div className="demo-top-bar-right" style={{ display: 'flex', alignItems: 'center', gap: '14px' }}>
        ...
        <button className="hamburger" onClick={() => setSidebarOpen(!sidebarOpen)} style={{ display: 'none' }}>
          <span />
          <span />
          <span />
        </button>
      ...
      <div style={{ display: 'flex', paddingTop: '60px', minHeight: '100vh' }}>
        {/* Sidebar */}
        <aside
          className={`demo-sidebar ${sidebarOpen ? 'open' : ''}`}
          style={{
            width: '220px',
            flexShrink: 0,
            ...
            {tabs.map((t) => (
              <button
                ...
                style={{
                  ...
                  width: '100%',
                  textAlign: 'left',
                  background: activeTab === t ? 'rgba(107,92,231,0.1)' : 'transparent',
                  border: 'none',
                  borderRadius: '8px',
                  padding: '9px 12px',
                  fontSize: '13px',
              ...
              >
                {sidebarIcon(t)}
                {t}
                {t === 'Approvals' && <span style={{ marginLeft: 'auto', background: '#6B5CE7', color: '#fff', fontSize: '10px', fontWeight: 700, borderRadius: '100px', padding: '1px 7px' }}>2</span>}
              </button>
            ))}
          </div>
        ...
        {/* Main content */}
        <main className="demo-main-content" style={{ flex: 1, padding: '40px 48px', maxWidth: '1000px' }}>
...
function OverviewTab() {
  return (
    <>
      ...
      {/* Metrics grid */}
      <div className="demo-metrics-grid" style={{ display: 'grid', gridTemplateColumns: 'repeat(2, 1fr)', gap: '12px', marginBottom: '32px' }}>
        {metrics.map((m) => (
